...
const Page7 = () => {
    ...
    const renderTableRows = (tableIndex) => {
        ...
        return cellValues[tableIndex].map((row, rowIndex) => (
            <tr key={rowIndex}>
                <td style={{ color: rowIndex === 0 ? 'black' : 'inherit' }}>{rowIndex === 0 ? specialValue : rowIndex === cellValues[tableIndex].length - 1 ? <span style={{ color: 'black' }}>ANS</span> : <span style={{ color: 'black' }}>#</span>}</td>
