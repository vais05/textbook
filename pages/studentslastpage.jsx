...
const Page12 = () => {
    ...
    const renderTableRows = (tableIndex) => {
        ...
        return cellValues[tableIndex].map((row, rowIndex) => (
            <tr key={rowIndex}>
                <td style={{ color: rowIndex === 0 ? 'black' : 'inherit' }}>{rowIndex === 0 ? specialValue : rowIndex === cellValues[tableIndex].length - 1 || rowIndex === cellValues[tableIndex].length - 2 ? 'ANS' : '#'}</td>
