        ...
        return cellValues[tableIndex].map((row, rowIndex) => (
            <tr key={rowIndex}>
                <td style={{ backgroundColor: "white", color: "black" }}>
                    {rowIndex === cellValues[tableIndex].length - 1 ||
                    rowIndex === cellValues[tableIndex].length - 2
                        ? "ANS"
                        : "#"}
                </td>
                    ...
                    colIndex !== 10 && (
                        <td key={colIndex} style={{ backgroundColor: "white" }}>
                            <input
                                ...
                                value={cell}
                                onChange={(e) =>
                                    handleCellValueChange(tableIndex, rowIndex, colIndex, e.target.value)
                                }
            ...
            <div className="table-container gap">
                {Object.keys(cellValues).map((tableKey, index) => (
                    <table key={index} style={{ marginTop: "20px", marginLeft: "20px", marginRight: "20px" }}>
                        ...
                        <tbody>{renderTableRows(tableKey)}</tbody>
                    </table>
                ))}
            </div>
